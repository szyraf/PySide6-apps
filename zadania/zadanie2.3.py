    ...
    def buttonClicked(self):
        ...
        try:
            ...
            if buttontext == ",":
                ...
                self.lineEdit.setText(self.makeGood(str(self.lineEditToFloat() * self.lineEditToFloat()).replace(".", ",")))
            elif buttontext == "√x":
                ...
                if self.remeberNumber2 == 0:
                    ...
                    if self.remeberSign == "+":
                        self.lineEdit.setText(self.makeGood(str(self.remeberNumber + self.remeberNumber2).replace(".", ",")))
                    ...
                    if self.remeberSign == "+":
                        self.lineEdit.setText(self.makeGood(str(self.lineEditToFloat() + self.remeberNumber2).replace(".", ",")))
                    elif self.remeberSign == "-":
                        self.lineEdit.setText(self.makeGood(str(self.lineEditToFloat() - self.remeberNumber2).replace(".", ",")))
                    elif self.remeberSign == "×":
                        self.lineEdit.setText(self.makeGood(str(self.lineEditToFloat() * self.remeberNumber2).replace(".", ",")))
